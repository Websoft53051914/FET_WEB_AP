    ...
    init: function() {
        Morris.Area({
            ...
            Morris.Donut({
                ...
                backgroundColor: "rgba(0, 36, 116), 0.5)",
                labelColor: vihoAdminConfig.primary,
                colors: ["rgba(0, 36, 116), 1)", "rgba(186, 137, 93, 1)" ,"rgba(9,9, 9, 1)" ,"rgba(113, 113, 113, 1)" ,"rgba(230, 237, 239, 1)", "rgba(210, 45, 61, 1)" ,"rgba(0, 36, 116), 1)"],

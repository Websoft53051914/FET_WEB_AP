    ...
    if (!E.jstree) {
        ...
        !c && i && (c = function (e, t) {
                    ...
                    var r = null,
                        ...
                        a = function (e, c) {
                            ...
                            if (t.length && t[0].id !== c && t[0].parent !== c) {
                                for (o = 0, d = t.length; o < d; o++) { t[o].children || (t[o].children = []); t[o].state = typeof t[o].state === "object" ? t[o].state : {}; var k = t[o].id.toString(); if ("__proto__" !== k && "constructor" !== k && "prototype" !== k) u[k] = t[o]; }
                                ...
                                for (o = 0, d = a.parents.length; o < d; o++) { var k = a.parents[o]; ("__proto__" !== k && "constructor" !== k && "prototype" !== k) && (u[k].children_d = u[k].children_d.concat(s)); }
                                ...
                                for(a.children=r,a.children_d=s,o=0,d=a.parents.length;o<d;o++){var k=a.parents[o];("__proto__"!==k&&"constructor"!==k&&"prototype"!==k)&&(u[k].children_d=u[k].children_d.concat(s));}
                                f = {
                                    cnt: g,
                                    mod: u,
                                    sel: e,
            ...
            get_json: function (e, t, i) {
                ...
                if (t && t.no_li_attr && delete r.li_attr, t && t.no_a_attr && delete r.a_attr, t && t.no_id && (delete r.id, r.li_attr && r.li_attr.id && delete r.li_attr.id, r.a_attr && r.a_attr.id && delete r.a_attr.id), t && t.flat && e.id !== E.jstree.root && i.push(r), !t || !t.no_children)

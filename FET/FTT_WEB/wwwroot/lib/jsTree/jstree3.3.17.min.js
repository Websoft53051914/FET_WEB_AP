    ...
    if (!E.jstree) {
        ...
        !c && i && (c = function (e, t) {
            ...
            _kbevent_to_func: function (e) {
                ...
                var r = this.settings.core.keyboard,
                    s, a;
                for (s in r)
                    if (r.hasOwnProperty(s) && (a = "-" !== (a = s) && "+" !== a ? (a = a.replace("--", "-MINUS").replace("+-", "-MINUS").replace("++", "-PLUS").replace("-+", "-PLUS")).split(/-|\+/).sort().join("-").replace("MINUS", "-").replace("PLUS", "+").toLowerCase() : a) === i) return r[s];
                return null
            },
            teardown: function () {
                        ...
                        a = function (e, c) {
                            var t = (e = e.data ? e.data : e).dat,
                                ...
                                n, o, d, f, p = function (e, t, i) {
                                    ...
                                    var childrenCount = (u[d.id] = d).children.length;
                                    var loopCount = Math.min(childrenCount, maxChildren);
                                ...
                                m = function (e, t, i) {
                                    ...
                                    if (d.li_attr.id && !d.id && 0 !== d.id && (d.id = d.li_attr.id.toString()), d.id || 0 === d.id || (d.id = r), d.li_attr.id || (d.li_attr.id = d.id), e && "object" == typeof e.a_attr)
                                        for (s in e.a_attr) e.a_attr.hasOwnProperty(s) && (d.a_attr[s] = e.a_attr[s]);
                                    var maxChildren = 1000; // 安全上限
                                    if (e && Array.isArray(e.children) && e.children.length) {
                                        var childrenCount = Math.min(e.children.length, maxChildren);
                                        for (s = 0; s < childrenCount; s++) {
                                            n = m(e.children[s], d.id, i);
                                            o = u[n];
                                            d.children.push(n);
                                            if (Array.isArray(o.children_d) && o.children_d.length) {
                                                d.children_d = d.children_d.concat(o.children_d);
                                            }
                                        }
                            ...
                            if (t.length && t[0].id !== c && t[0].parent !== c) {
                                var maxItems = 1000; // 安全上限
                                if (Array.isArray(t) && t.length) {
                                    var loopCount = Math.min(t.length, maxItems);
                                    for (o = 0; o < loopCount; o++) {
                                        t[o].children || (t[o].children = []);
                                        t[o].state = typeof t[o].state === "object" ? t[o].state : {};
                                        var k = t[o].id.toString();
                                ...
                                if (Array.isArray(t) && t.length) {
                                    var loopCount = Math.min(t.length, maxItems);
                                    for (o = 0; o < loopCount; o++) {
                                        var parentId = t[o].parent?.toString();
                                        var nodeId = t[o].id?.toString();
                                        if (!parentId || !nodeId) continue; // 防護 null/undefined

                                        if (u[parentId]) {
                                            u[parentId].children.push(nodeId);
                                            a.children_d.push(nodeId);
                                        } else if (v !== undefined) {
                                            v._data.core.last_error = {
                                                ...
                                                data: JSON.stringify({ id: nodeId, parent: parentId })
                                            };
                                ...
                                for (o = 0; o < loopCount; o++) {
                                    ...
                                    s.push(n);
                                    if (u[n].children_d.length) {
                                        s = s.concat(u[n].children_d);
                                    }
                                }

                                var maxParents = 1000; // 安全上限
                                if (Array.isArray(a.parents) && a.parents.length) {
                                    var parentsCount = Math.min(a.parents.length, maxParents);
                                    for (o = 0; o < parentsCount; o++) {
                                        var k = a.parents[o];
                                        if (k !== "__proto__" && k !== "constructor" && k !== "prototype") {
                                            u[k].children_d = u[k].children_d.concat(s);
                                        }
                                    }
                                }
                                ...
                                if (Array.isArray(t) && t.length) {
                                    var loopCount = Math.min(t.length, maxItems);
                                    for (o = 0; o < loopCount; o++) {
                                        n = m(t[o], i, Array.isArray(a.parents) ? a.parents.concat() : []);
                                        if (n) {
                                            r.push(n);
                                            s.push(n);
                                            if (u[n] && Array.isArray(u[n].children_d) && u[n].children_d.length) {
                                                s = s.concat(u[n].children_d);
                                            }
                                        }
                                    }
                                ...
                                var parentsCount = a.parents.length;
                                var loopCount = Math.min(parentsCount, maxParents);
                            ...
                            if (null !== this.element) {
                                ...
                                if (this._model.data = e.mod, t) {
                                    ...
                                    if (n.length !== o.length || E.vakata.array_unique(n.concat(o)).length !== n.length) {
                                        var maxItems = 1000; // 安全上限
                                        var loopCount = Math.min(n.length, maxItems);

                                        for (i = 0; i < loopCount; i++) {
                                            if (-1 === E.inArray(n[i], a) && -1 === E.inArray(n[i], o)) {
                                                r[n[i]].state.selected = false;
                                            }
                                        }

                                        var maxItems = 1000; // 安全上限
                                        var loopCount = Math.min(o.length, maxItems);

                                        for (i = 0; i < loopCount; i++) {
                                            if (-1 === E.inArray(o[i], n)) {
            ...
            _parse_model_from_json: function (e, t, i) {
                ...
                if (e && (e.id || 0 === e.id) && (l.id = e.id.toString()), e && e.text && (l.text = e.text), e && e.data && e.data.jstree && e.data.jstree.icon && (l.icon = e.data.jstree.icon), l.icon !== P && null !== l.icon && "" !== l.icon || (l.icon = !0), e && e.data && (l.data = e.data, e.data.jstree))
                ...
                if (e && e.children && e.children.length) {
                    var maxChildren = 1000; // 設定安全上限
                    var children = Array.isArray(e.children) ? e.children : []; // 確保是陣列
                    for (s = 0, a = Math.min(children.length, maxChildren); s < a; s++) o = d[n = this._parse_model_from_json(e.children[s], l.id, i)], l.children.push(n), o.children_d.length && (l.children_d = l.children_d.concat(o.children_d));
            ...
            _redraw: function () {
                var maxItems = 1000; // 安全上限
                var e = (this._model.force_full_redraw ? this._model.data[E.jstree.root].children : this._model.changed).concat([]);
                var t = b.createElement("UL");
                var i, r, s, a = this._data.core.focused;

                // 限制迴圈次數
                var loopCount = Math.min(e.length, maxItems);
            ...
            redraw_node: function (e, t, i, r) {
                ...
                for (s.a_attr.id || (s.a_attr.id = s.id + "_anchor"), e.childNodes[1].setAttribute("aria-selected", !!s.state.selected), e.childNodes[1].setAttribute("aria-level", s.parents.length), this.settings.core.compute_elements_positions && (e.childNodes[1].setAttribute("aria-setsize", g[s.parent].children.length), e.childNodes[1].setAttribute("aria-posinset", g[s.parent].children.indexOf(s.id) + 1)), s.state.disabled && e.childNodes[1].setAttribute("aria-disabled", !0), d = 0, c = s.children.length; d < c; d++)
                    ...
                    for (d++, c = Math.min(g[s.parent].children.length, maxLength); d < c; d++)
                ...
                if (h.length && (e.childNodes[1].className = "jstree-anchor " + h), (s.icon && !0 !== s.icon || !1 === s.icon) && (!1 === s.icon ? e.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden" : -1 === s.icon.indexOf("/") && -1 === s.icon.indexOf(".") ? e.childNodes[1].childNodes[0].className += " " + s.icon + " jstree-themeicon-custom" : (e.childNodes[1].childNodes[0].style.backgroundImage = 'url("' + s.icon + '")', e.childNodes[1].childNodes[0].style.backgroundPosition = "center center", e.childNodes[1].childNodes[0].style.backgroundSize = "auto", e.childNodes[1].childNodes[0].className += " jstree-themeicon-custom")), this.settings.core.force_text ? e.childNodes[1].appendChild(_.createTextNode(s.text)) : e.childNodes[1].appendChild(document.createTextNode(String(s.text))), t && s.children.length && (s.state.opened || r) && s.state.loaded) {
            ...
            open_all: function (e, i, r) {
                if (e = e || E.jstree.root, !(e = this.get_node(e))) return !1;
                var t = e.id === E.jstree.root ? this.get_container_ul() : this.get_node(e, !0),
                    s, a, n;
                if (!t.length) {
            ...
            close_all: function (e, t) {
                if (e = e || E.jstree.root, !(e = this.get_node(e))) return !1;
                var i = e.id === E.jstree.root ? this.get_container_ul() : this.get_node(e, !0),
                    r = this,
                    s, a;
            ...
            get_top_selected: function (returnNodes) {
                const selectedNodes = this.get_selected(true); // 取得所有選中節點
                const safeMap = new Map(); // 使用 Map 避免原型污染
                ...
                selectedNodes.forEach(node => {
                    node.children_d.forEach(childId => {
                        safeMap.delete(childId);
                    });
                });

                // 3. 取出最終安全的 top-level ID 或節點
                const topSelectedIds = Array.from(safeMap.keys());

                if (returnNodes) {
                    return topSelectedIds.map(id => this.get_node(id));
                } else {
                    return topSelectedIds;
                }
            },
            get_bottom_selected: function (e) {
                var t = this.get_selected(true), i = [], r, s;
                var maxItems = 1000; // 安全上限
                var items = Array.isArray(t) ? t : []; // 確保 t 是陣列

                for (r = 0, s = Math.min(items.length, maxItems); r < s; r++) {
                    const safeId = String(t[r].id).replace(/[^a-zA-Z0-9_-]/g, '');
                    if (t[r].children.length === 0) i.push(safeId);
                }
            ...
            get_json: function (e, t, i) {
                ...
                var maxChildren = 1000; // 安全上限
                var children = Array.isArray(e.children) ? e.children : [];

                if (t && t.no_li_attr) delete r.li_attr;
                if (t && t.no_a_attr) delete r.a_attr;
                if (t && t.no_id) {
                    delete r.id;
                    if (r.li_attr && r.li_attr.id) delete r.li_attr.id;
                    if (r.a_attr && r.a_attr.id) delete r.a_attr.id;
                }
                if (t && t.flat && e.id !== E.jstree.root) i.push(r);

                if (!t || !t.no_children) {
                    for (s = 0, a = Math.min(children.length, maxChildren); s < a; s++) {
                        if (t && t.flat) {
                            this.get_json(children[s], t, i);
                        } else {
                            r.children.push(this.get_json(children[s], t));
                        }
                    }
                }
        ...
        l.className = "jstree-icon jstree-checkbox", l.setAttribute("role", "presentation"), E.jstree.defaults.checkbox = {
            ...
            this.bind = function () {
                ...
                for (i = 0, r = e.children_d.length; i < r; i++)
                    if (-1 !== E.inArray(e.children_d[i], a) || !n[e.children_d[i]].state.loaded && n[e.children_d[i]].original.state.undetermined) return !0;
                return !1
                ...
                if (A && (s.event && "dragover" === s.event.type && !a || clearTimeout(A)), s && s.data && s.data.jstree && (!s.event.target.id || "jstree-marker" !== s.event.target.id)) {
                    ...
                    if (n && n._data && n._data.dnd)
                        if (S.attr("class", "jstree-" + n.get_theme() + (n.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")), x = s.data.origin && (s.data.origin.settings.dnd.always_copy || s.data.origin.settings.dnd.copy && (s.event.metaKey || s.event.ctrlKey)), s.helper.children().attr("class", "jstree-" + n.get_theme() + " jstree-" + n.get_theme() + "-" + n.get_theme_variant() + " " + (n.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")).find(".jstree-copy").first()[x ? "show" : "hide"](), s.event.target !== n.element[0] && s.event.target !== n.get_container_ul()[0] || 0 !== n.get_container_ul().children().length && !n.settings.dnd.blank_space_drop) {
                            ...
                            for (f = !0, p = 0, m = s.data.nodes.length; p < m; p++)
                                if (!(f = f && n.check(s.data.origin && (s.data.origin.settings.dnd.always_copy || s.data.origin.settings.dnd.copy && (s.event.metaKey || s.event.ctrlKey)) ? "copy_node" : "move_node", s.data.origin && s.data.origin !== n ? s.data.origin.get_node(s.data.nodes[p]) : s.data.nodes[p], E.jstree.root, "last", {
                                    dnd: !0,
